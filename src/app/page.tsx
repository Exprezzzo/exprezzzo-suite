  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-6 text-center">
      <header className="mb-12">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-24 h-24 mx-auto text-primary mb-4">
        ...
        <p className="mt-4 text-xl text-foreground/80">
          Securely manage your Exprezzzo Intelligence System account.
        </p>
      </header>

      <main className="space-y-6">
        <p className="text-lg text-foreground/70">
          Join us to experience seamless access to our suite of intelligence tools.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" asChild className="shadow-lg hover:shadow-primary/30 transition-shadow duration-300">
            <Link href="/login">Log In</Link>
          </Button>
          <Button size="lg" variant="outline" asChild className="shadow-lg hover:shadow-accent/30 transition-shadow duration-300">
